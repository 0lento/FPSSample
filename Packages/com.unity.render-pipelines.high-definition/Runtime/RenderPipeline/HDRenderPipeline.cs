...
// sample-game end
            ...
            )
        {
            ...
            {
                criteria = SortingCriteria.CanvasOrder | SortingCriteria.OptimizeStateChanges | SortingCriteria.RenderQueue | SortingCriteria.SortingLayer  // Decals force a depth-prepass so there is no reason to break batches with QuantizedFrontToBack
            };
